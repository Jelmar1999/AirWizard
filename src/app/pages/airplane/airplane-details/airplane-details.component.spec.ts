...
describe('AirplaneDetailsComponent', () => {
  ...
  it('should display all information correctly', (done: DoneFn) => {
    ...
    const li6 = fixture.debugElement.nativeElement.querySelector('#buildYear')
    const li7 = fixture.debugElement.nativeElement.querySelector('#weigthClass')
    ...
    expect(li6.innerHTML).toEqual('Buildyear: 1-1-2017')
    expect(li7.innerHTML).toEqual('Weight Class: Heavy')
    fixture.destroy()
    done()
  })
